...
export default function BioCard() {
  const coreStack = ["JavaScript", "TypeScript", "Python", "SQL", "Tableau", "Figma"];
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 flex-1">
        ...
        <div className="flex-1 flex flex-col justify-center py-2">
          ...
          <p className="text-base md:text-lg leading-relaxed text-primary mb-6">
            Fresh graduate building data-driven web apps, operational dashboards, and workflow automation tools.
          </p>
