...
export const portfolioData: PortfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      impact: [
        "Achieved **MAE of 0.306** against a baseline of 0.424, a **27.9% improvement** with zero data leakage.",
      ...
      pipelineSteps: [
        ...
        { label: "Dribble Filtering", description: "Filter to dribble events for flair positions (winger, striker, CAM) with a minimum of 5 attempts. Identify **4,027 dribble events including 354 nutmegs**.", icon: "filter" },
        ...
        { label: "Model Training", description: "Train **XGBoost Regressor** with strong regularization. Compare against Poisson Regressor and global mean baseline.", icon: "cpu" },
        { label: "SHAP & Dashboard", description: "Generate global and per-player **SHAP feature attributions**. Deploy three-page Streamlit app: Flair Index ranking, Player Lab, and **Model Integrity** page.", icon: "layout-dashboard" },
      ],
    },
    {
